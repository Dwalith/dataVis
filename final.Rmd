...
```{r}
generate_custom_plot <- function(x_data, y_data, col, plot_title, x_label = "UMAP_1", y_label = "UMAP_2", sha = NULL) { 
...
#### Plot Replicate 2
```{r, cache=TRUE}
autoplot(pca, data = metadata, colour="replicate") +
  ggtitle("PCA Plot - Color by Replicate") + theme_minimal() + theme(
    plot.title = element_text(hjust = 0.5, face = "bold"))
```

#### Plot Strain 2
```{r, cache=TRUE}
autoplot(pca, data = metadata, colour="strain") +  
  ggtitle("PCA Plot - Color by Strain") + theme_minimal() + theme(
    plot.title = element_text(hjust = 0.5, face = "bold"))
```

#### Plot Time 2
```{r, cache=TRUE}
autoplot(pca, data = metadata, colour="time") +
  ggtitle("PCA Plot - Color by Time") + theme_minimal() + theme(
    plot.title = element_text(hjust = 0.5, face = "bold"))
```
...
#### Plot Replicate 2
```{r, cache=TRUE}
autoplot(pca_res_scaled, data = metadata, colour="replicate") +
  ggtitle("PCA Plot - Color by Replicate") + theme_minimal() + theme(
    plot.title = element_text(hjust = 0.5, face = "bold"))
```
...
#### Plot Strain 2
```{r, cache=TRUE}
autoplot(pca_res_scaled, data = metadata, colour="strain") +  
  ggtitle("PCA Plot - Color by Strain") + theme_minimal() + theme(
    plot.title = element_text(hjust = 0.5, face = "bold"))
```
...
#### Plot Time 2
```{r, cache=TRUE}
autoplot(pca_res_scaled, data = metadata, colour="time") +
  ggtitle("PCA Plot - Color by Time") + theme_minimal() + theme(
    plot.title = element_text(hjust = 0.5, face = "bold"))
```
...
### Normalized PCA 1
```{r, cache=TRUE}
autoplot(pca_norm, data = metadata, colour="replicate") +
  ggtitle("PCA Plot")+ labs(subtitle = "Color by Replicate without outlier") + 
...
### Normalized PCA 1
```{r, cache=TRUE}
autoplot(pca_norm, data = filtered_metadata, colour="replicate") +
  ggtitle("PCA Plot") + labs(subtitle = "Color by Replicate without outlier") + 
  theme_minimal() + theme(plot.title = element_text(hjust = 0.5, face = "bold"))
...
tsne1 <- Rtsne(merged_data,perplexity = 5, max_iter = 1000, pca = TRUE)
...
ggplot(tsne_plot) +
  ...
  labs(x = "tSNE1", y = "tSNE2", title = "Raw data tSNE projection by Replicate and Strain") + labs(color = "Replicate", shape = "Strain")
```
...
tsne_plot <- data.frame(x = tsne1$Y[,1],
                        y = tsne1$Y[,2],
                        col = as.factor(metadata$time),
                        sha = metadata$strain)

ggplot(tsne_plot) + geom_point(aes(x=x, y=y, color=col, shape=sha)) + labs(color = "Time", shape = "Strain") + scale_shape_manual(values=c(3, 16)) + labs(x = "tSNE1", y = "tSNE2", title = "Raw data tSNE projection by Time and Strain")
```
...
# Ensure metadata has the same number of rows as t-SNE result
...
ggplot(tsne_plot) + geom_point(aes(x = x, y = y, color = col, shape = sha)) + 
  labs(color = "Replicate", shape = "Strain") + scale_shape_manual(values=c(3, 16)) + labs(x = "tSNE1", y = "tSNE2", title = "Normalized tSNE projection by Replicate and Strain")
...
# Plot the data
ggplot(tsne_plot) + geom_point(aes(x = x, y = y, color = col, shape = sha)) + 
  labs(color = "Replicate", shape = "Strain") + scale_shape_manual(values=c(3, 16)) + labs(x = "tSNE1", y = "tSNE2", title = "Normalized tSNE projection", subtitle = "Replicate and Strain without the outlier")
...
X_tsne <- Rtsne(normalized_filtered_data, perplexity = 1, pca = TRUE)
  
  # Create a data frame for the t-SNE plot
  tsne_plot <- data.frame(
    x = X_tsne$Y[, 1],
    y = X_tsne$Y[, 2],
    col = as.factor(filtered_metadata$replicate),
  ...
  gg <- ggplot(tsne_plot) +
    ...
    labs(x = "tSNE1", y = "tSNE2",title = paste("Perplexity = 1"),color = "Replicate", shape = "Strain")
  print(gg)
...
Y = normalized_filtered_data
X_tsne <- Rtsne(Y, perplexity = 5, pca = TRUE)
  ...
  gg <- ggplot(tsne_plot) +
    geom_point(aes(x = x, y = y, color = col, shape = sha)) +
    scale_shape_manual(values = c(3, 17)) +
    labs(x = "tSNE1", y = "tSNE2",title = paste("Perplexity = 5"),color = "Replicate", shape = "Strain")
  print(gg)
...
X_tsne <- Rtsne(Y, perplexity = 10, pca = TRUE)
  ...
  gg <- ggplot(tsne_plot) +
    geom_point(aes(x = x, y = y, color = col, shape = sha)) +
    scale_shape_manual(values = c(3, 17)) +
    labs(x = "tSNE1", y = "tSNE2",title = paste("Perplexity = 10"),color = "Replicate", shape = "Strain")
  print(gg)
...
X_tsne <- Rtsne(Y, perplexity = 15, pca = TRUE)
  ...
  gg <- ggplot(tsne_plot) +
    geom_point(aes(x = x, y = y, color = col, shape = sha)) +
    scale_shape_manual(values = c(3, 17)) +
    labs(x = "tSNE1", y = "tSNE2",title = paste("Perplexity = 15"),color = "Replicate", shape = "Strain")
  print(gg)
...
X_tsne <- Rtsne(Y, perplexity = 5 ,max_iter = 1, pca = TRUE)
  ...
  gg <- ggplot(tsne_plot) +
    geom_point(aes(x = x, y = y, color = col, shape = sha)) +
    scale_shape_manual(values = c(3, 17)) +
    labs(x = "tSNE1", y = "tSNE2",title = paste("Number of Iterations = 1"),color = "Replicate", shape = "Strain")
  print(gg)
...
X_tsne <- Rtsne(Y, perplexity = 5 ,max_iter = 10, pca = TRUE)
  ...
  gg <- ggplot(tsne_plot) +
    geom_point(aes(x = x, y = y, color = col, shape = sha)) +
    scale_shape_manual(values = c(3, 17)) +
    labs(x = "tSNE1", y = "tSNE2",title = paste("Number of Iterations = 10"),color = "Replicate", shape = "Strain")
  print(gg)
...
X_tsne <- Rtsne(Y, perplexity = 5 ,max_iter = 100, pca = TRUE)
  ...
  gg <- ggplot(tsne_plot) +
    geom_point(aes(x = x, y = y, color = col, shape = sha)) +
    scale_shape_manual(values = c(3, 17)) +
    labs(x = "tSNE1", y = "tSNE2",title = paste("Number of Iterations = 100"),color = "Replicate", shape = "Strain")
  print(gg)
...
X_tsne <- Rtsne(Y, perplexity = 5 ,max_iter = 1000, pca = TRUE)
  ...
  gg <- ggplot(tsne_plot) +
    geom_point(aes(x = x, y = y, color = col, shape = sha)) +
    scale_shape_manual(values = c(3, 17)) +
    labs(x = "tSNE1", y = "tSNE2",title = paste("Number of Iterations = 1000"),color = "Replicate", shape = "Strain")
  print(gg)
...
### Iteration 10000
```{r  cache=TRUE}
X_tsne <- Rtsne(Y, perplexity = 5 ,max_iter = 10000, pca = TRUE)
  ...
  gg <- ggplot(tsne_plot) +
    geom_point(aes(x = x, y = y, color = col, shape = sha)) +
    scale_shape_manual(values = c(3, 17)) +
    labs(x = "tSNE1", y = "tSNE2",title = paste("Number of Iterations = 10000"),color = "Replicate", shape = "Strain")
  print(gg)
...
generate_custom_plot(all_dataSet_UMAP$layout[,1], all_dataSet_UMAP$layout[,2], metadata$strain, sha = metadata$replicate, "UMAP: All data raw") + labs(color = "Strain", shape = "Replicate")
```

### UMAP Time
```{r}
generate_custom_plot(all_dataSet_UMAP$layout[,1], all_dataSet_UMAP$layout[,2], metadata$time, sha = metadata$replicate, "UMAP: All data raw") + labs(color = "Time", shape = "Replicate")
```
...
generate_custom_plot(all_dataSet_UMAP_norm$layout[,1], all_dataSet_UMAP_norm$layout[,2], metadata$strain, sha = metadata$replicate, "UMAP: Normalized data with outlier") + labs(color = "Strain", shape = "Replicate")
```

### UMAP Time
```{r}
generate_custom_plot(all_dataSet_UMAP_norm$layout[,1], all_dataSet_UMAP_norm$layout[,2], metadata$time, sha = metadata$replicate, "UMAP: Normalized data with outlier") + labs(color = "Time", shape = "Replicate")
```
## {-}
...
generate_custom_plot(all_dataSet_UMAP_norm$layout[,1], all_dataSet_UMAP_norm$layout[,2], filtered_metadata$strain, sha = filtered_metadata$replicate, "UMAP: Normalized data without outlier") + labs(color = "Strain", shape = "Replicate")
```

### UMAP Time
```{r}
generate_custom_plot(all_dataSet_UMAP_norm$layout[,1], all_dataSet_UMAP_norm$layout[,2], filtered_metadata$time, sha = filtered_metadata$replicate, "UMAP: Normalized data without outlier") + labs(color = "Time", shape = "Replicate")
```
...
generate_custom_plot(dataset_predict[,1], dataset_predict[,2], predicted_metadata$strain, sha = predicted_metadata$replicate, "UMAP: Prediction data") + labs(color = "Strain", shape = "Replicate")

```

### Predicted data 1 Time
```{r}
generate_custom_plot(dataset_predict[,1], dataset_predict[,2], predicted_metadata$time, sha = predicted_metadata$replicate, "UMAP: Prediction data") + labs(color = "Time", shape = "Replicate")
...
generate_custom_plot(umap_result$layout[,1], umap_result$layout[,2], filtered_metadata$strain, sha = filtered_metadata$replicate, "UMAP: Number of Neighbors 2") + labs(color = "Strain", shape = "Replicate")
...
generate_custom_plot(umap_result$layout[,1], umap_result$layout[,2], filtered_metadata$strain, sha = filtered_metadata$replicate, "UMAP: Number of Neighbors 5") + labs(color = "Strain", shape = "Replicate")
...
generate_custom_plot(umap_result$layout[,1], umap_result$layout[,2], filtered_metadata$strain, sha = filtered_metadata$replicate, "UMAP: Number of Neighbors 10") + labs(color = "Strain", shape = "Replicate")
...
generate_custom_plot(umap_result$layout[,1], umap_result$layout[,2], filtered_metadata$strain, sha = filtered_metadata$replicate, "UMAP: Number of Neighbors 20") + labs(color = "Strain", shape = "Replicate")
...
generate_custom_plot(umap_result$layout[,1], umap_result$layout[,2], filtered_metadata$strain, sha = filtered_metadata$replicate, "UMAP: Number of Neighbors 40") + labs(color = "Strain", shape = "Replicate")
```
...
generate_custom_plot(umap_result$layout[,1], umap_result$layout[,2], filtered_metadata$strain, sha = filtered_metadata$replicate, "UMAP: Value of min_dist 0.1") + labs(color = "Strain", shape = "Replicate")
```

#### Run UMAP with min_dist = 0.5
```{r}
umap_result <- umap::umap(normalized_filtered_data, min_dist = 0.5)
generate_custom_plot(umap_result$layout[,1], umap_result$layout[,2], filtered_metadata$strain, sha = filtered_metadata$replicate, "UMAP: Value of min_dist 0.5") + labs(color = "Strain", shape = "Replicate")
```

#### Run UMAP with min_dist = 0.9
```{r}
umap_result <- umap::umap(normalized_filtered_data, min_dist = 0.9)
generate_custom_plot(umap_result$layout[,1], umap_result$layout[,2], filtered_metadata$strain, sha = filtered_metadata$replicate, "UMAP: Value of min_dist 0.9") + labs(color = "Strain", shape = "Replicate")
```
...
generate_custom_plot(umap_result$layout[,1], umap_result$layout[,2], filtered_metadata$strain, sha = filtered_metadata$replicate, "UMAP: Euclidean Distance") + labs(color = "Strain", shape = "Replicate")
```

#### Run UMAP with Manhattan metric
```{r}
umap_result <- umap::umap(normalized_filtered_data, metric = "manhattan")
generate_custom_plot(umap_result$layout[,1], umap_result$layout[,2], filtered_metadata$strain, sha = filtered_metadata$replicate, "UMAP: Manhattan Distance") + labs(color = "Strain", shape = "Replicate")
```

#### Run UMAP with Cosine metric
```{r}
umap_result <- umap::umap(normalized_filtered_data, metric = "cosine")
generate_custom_plot(umap_result$layout[,1], umap_result$layout[,2], filtered_metadata$strain, sha = filtered_metadata$replicate, "UMAP: Cosine Distance") + labs(color = "Strain", shape = "Replicate")
```
